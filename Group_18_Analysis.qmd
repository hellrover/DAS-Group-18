...
model_nb<-glm.nb(time_at_shelter~animal_type+intake_type+outcome_type+chip_status,data=animal.sub)
summary(model_nb)
```

```{r}
plot(model_nb$fitted.values, residuals(model3, type = "deviance"),
